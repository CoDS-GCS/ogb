...
def main():
    ...
    dataset_name = "dblp-2022-03-01_test_URI_Only"
    ...
    dataset = PygNodePropPredDataset_hsh(name=dataset_name,root = '/media/hussein/UbuntuData/GithubRepos/KG-EaaS/DBLP_Usecase/')
    ...
    feat = torch.Tensor(data.num_nodes_dict['rec'], 2)
    ...
    if args.loadTrainedModel==1:
        ...
        # print(out_df)
        out_df.to_csv("RGCN_DBLP_output.csv",index=None)

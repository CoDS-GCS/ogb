...
def main():
    ...
    dataset = PygNodePropPredDataset_hsh(name=dataset_name,root='/shared_mnt/DBLP/',numofClasses='50')
    ...
    pd.DataFrame(dic_results).transpose().to_csv("/shared_mnt/DBLP/"+dataset_name+ "_RGCN_times.csv",
        index=False)

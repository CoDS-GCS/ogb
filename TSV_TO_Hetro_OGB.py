...
if __name__ == '__main__':
    ...
    root_path = "/media/hussein/UbuntuData/OGBN_Datasets/Sparql_Sampling/"
    sampledQueries = ["BStarQuery","PathQuery","BPathQuery"]
    for i, row in fieldOfStudy_Coverage_df.iterrows():
        ...
        if i >= 0:
            ...
            pd.DataFrame(dic_results).transpose().to_csv("/media/hussein/UbuntuData/OGBN_Datasets/Sparql_Sampling/OGBN_MAG_Uscases_CSVtoHetrog_times" + ".csv", index=False)
                # print(entites_dic)
